<x-app-layout>
    <x-container class="py-8">
        <!-- Page Header -->
        <x-page-header title="Dashboard" description="View and manage recent documents">
            <div class="flex flex-col sm:flex-row gap-4 mt-6">
                <!-- Search Form -->
                <form action="{{ route('dashboard') }}" method="GET" class="flex flex-1 gap-2">
                    <x-input 
                        type="text"
                        name="search" 
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div class="flex gap-2 flex-wrap">
                <a href="{{ route('dashboard', ['sort_by' => 'created_at']) }}"
                ...
                <a href="{{ route('dashboard', ['sort_by' => 'name']) }}"
