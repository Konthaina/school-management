        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-semibold text-2xl text-gray-900 dark:text-white leading-tight flex items-center gap-3">
                    <a href="{{ route('admin.profiles.index') }}" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition">
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="px-6 sm:px-8 py-8">
                    ...
                    <form action="{{ route('admin.profiles.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <select name="user_id" 
                                        id="user_id" 
                                        required
                                        class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:ring-indigo-500 dark:focus:ring-indigo-600 focus:border-indigo-500 dark:focus:border-indigo-600 sm:text-sm shadow-sm">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <textarea name="bio" 
                                          ...
                                          class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:ring-indigo-500 dark:focus:ring-indigo-600 focus:border-indigo-500 dark:focus:border-indigo-600 sm:text-sm shadow-sm">{{ old('bio') }}</textarea>
                                @error('bio')
                                    <p class="text-red-600 dark:text-red-400 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="flex gap-3 border-t border-gray-200 dark:border-gray-700 pt-8">
                            <a href="{{ route('admin.profiles.index') }}" class="flex-1 inline-flex items-center justify-center px-4 py-3 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-900 dark:text-white font-medium rounded-lg transition">
                                <i class="fas fa-times mr-2"></i>Cancel
                            </a>
                            <button type="submit" class="flex-1 inline-flex items-center justify-center px-4 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg shadow-sm transition">
            ...
            <div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                <div class="flex gap-3">
                    ...
                    <div>
                        <h3 class="font-semibold text-blue-900 dark:text-blue-200">New Profile</h3>
                        <p class="text-blue-800 dark:text-blue-300 text-sm mt-1">Fill in the user's profile information. All fields are optional except selecting a user. You can always update this information later.</p>
                    </div>
                </div>
            </div>
        </div>
