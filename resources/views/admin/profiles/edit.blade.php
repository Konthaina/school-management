        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                <div class="flex gap-3">
                    ...
                    <div>
                        <h3 class="font-semibold text-blue-900 dark:text-blue-200">Edit Tip</h3>
                        <p class="text-blue-800 dark:text-blue-300 text-sm mt-1">Make sure all information is accurate and up to date. Profile pictures should be clear and professional.</p>
                    </div>
                </div>
            </div>
        </div>
