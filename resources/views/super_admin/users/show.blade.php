<x-app-layout>
    <x-container class="py-8">
        ...
        <div class="flex items-center gap-4 mb-8">
            <x-button type="secondary" size="sm" onclick="window.location.href='{{ route('users.index') }}'">
        ...
        <x-card class="max-w-2xl">
            <div class="space-y-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3 pt-4">
                    <x-button type="primary" onclick="window.location.href='{{ route('users.edit', $user->id) }}'">
                        <i class="fas fa-edit mr-2"></i>Edit User
                    </x-button>
                    
                    <form action="{{ route('users.destroy', $user->id) }}" method="POST" class="flex-1 sm:flex-none">
                        @csrf
                        @method('DELETE')
                    ...
                    <x-button type="secondary" onclick="window.location.href='{{ route('users.index') }}'">
